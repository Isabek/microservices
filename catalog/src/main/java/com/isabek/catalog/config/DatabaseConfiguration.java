package com.isabek.catalog.config;

import com.isabek.catalog.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.isabek.catalog.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.isabek.catalog.repository.search")
